    ...
    <div className="pt-20 min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4 py-8">
        <div className="flex items-center mb-8">
          <BarChart2 className="h-8 w-8 text-primary-600 dark:text-primary-400 mr-3" />
          <div>
            <h1 className="text-3xl font-serif font-bold text-primary-900 dark:text-gray-100">Analytics Dashboard</h1>
            <p className="text-gray-600 dark:text-gray-300">Detailed statistics and insights about your platform</p>
          </div>
        </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalNovels}</h3>
              </div>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.totalChapters}</h3>
              </div>
            </div>
            <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-gray-100">{stats.featuredNovels}</h3>
              </div>
            </div>
            <div className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Genre Distribution</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {Object.entries(stats.genreDistribution)
              .sort(([, a], [, b]) => b - a)
              .map(([genre, count]) => (
                <div key={genre} className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4">
                  ...
                  <div className="mt-2 flex items-end">
                    ...
                    <div className="ml-2 text-sm text-gray-500 dark:text-gray-400">novels</div>
                  </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100 mb-4">Novel Status Overview</h2>
          <div className="space-y-4">
            <div className="flex items-center">
              <div className="w-24 text-sm text-gray-500 dark:text-gray-400">Ongoing</div>
              <div className="flex-1 h-4 bg-gray-100 dark:bg-gray-600 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-primary-500 dark:bg-primary-400 rounded-full"
                  style={{ width: `${(stats.ongoingNovels / stats.totalNovels) * 100}%` }}
                ></div>
              </div>
              <div className="ml-4 text-sm font-medium text-gray-700 dark:text-gray-300">{stats.ongoingNovels}</div>
            </div>
            <div className="flex items-center">
              <div className="w-24 text-sm text-gray-500 dark:text-gray-400">Completed</div>
              <div className="flex-1 h-4 bg-gray-100 dark:bg-gray-600 rounded-full overflow-hidden">
                <div 
                  className="h-full bg-success-500 dark:bg-green-400 rounded-full"
                  style={{ width: `${(stats.completedNovels / stats.totalNovels) * 100}%` }}
                ></div>
              </div>
              <div className="ml-4 text-sm font-medium text-gray-700 dark:text-gray-300">{stats.completedNovels}</div>
            </div>
          </div>
        </div>
      </div>
